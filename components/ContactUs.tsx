    ...
    <div className="max-w-6xl mx-auto py-16 px-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
        <div className="bg-white rounded-3xl border border-amari-100 p-7 shadow-sm hover:shadow-xl transition">
          <h3 className="text-xl font-serif font-bold text-amari-900 mb-2">Quick answers</h3>
        ...
        <div className="bg-white rounded-3xl border border-amari-100 p-7 shadow-sm hover:shadow-xl transition">
          <h3 className="text-xl font-serif font-bold text-amari-900 mb-2">Partnerships</h3>
        ...
        <div className="bg-white rounded-3xl border border-amari-100 p-7 shadow-sm hover:shadow-xl transition">
          <h3 className="text-xl font-serif font-bold text-amari-900 mb-2">Planning basics</h3>
